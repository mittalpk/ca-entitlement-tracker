...
|---|---|---|---|---|---|
| {date} | {model_version} | v1.0 | {n} | {finding} | {reviewer} |

> **⚠ SYNTHETIC DATA FLAG:** The above table is a template. It must be populated after the first build and quarterly thereafter.
