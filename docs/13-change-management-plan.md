...
|---|---|---|---|---|---|---|
| C-001 | 2026-07-30 | Standard | Initial v1.0 — documentation specification | Senior AI Solution Architect | N/A (first version) | 1.0.0 |
| CR-2026-001 | 2026-08-17 | Normal | Formula precision validation & security credential refactoring (`BK1-ISS-002`, `BK1-ISS-004`) | Workflow Engineer + Compliance Officer | 25/25 test cases PASSED | 1.1.0 |
